...
import { SiMongodb, SiTailwindcss, SiJavascript, SiPython, SiFlask, SiTensorflow, SiExpress, SiJsonwebtokens, SiRedux, SiSocketdotio } from 'react-icons/si'
import { BsArrowUpRight } from 'react-icons/bs'

// --- Tech icons map ---
const technologies = {
  'ReactJs': { icon: <FaReact className="text-[#61DAFB]" />, name: 'React' },
  'React.js': { icon: <FaReact className="text-[#61DAFB]" />, name: 'React' },
  'NodeJS': { icon: <FaNodeJs className="text-[#339933]" />, name: 'Node.js' },
  'Node.js': { icon: <FaNodeJs className="text-[#339933]" />, name: 'Node.js' },
  'Express.js': { icon: <SiExpress className="text-[#000000] dark:text-[#FFFFFF]" />, name: 'Express' },
  'MongoDB': { icon: <SiMongodb className="text-[#47A248]" />, name: 'MongoDB' },
  'JWT': { icon: <SiJsonwebtokens className="text-[#000000] dark:text-[#FFFFFF]" />, name: 'JWT' },
  ...
  'Redux': { icon: <SiRedux className="text-[#764ABC]" />, name: 'Redux' },
  'Socket.IO': { icon: <SiSocketdotio className="text-[#010101] dark:text-[#FFFFFF]" />, name: 'Socket.IO' },
...
const projects = [
  ...
  title: 'UZHAVAN',
  description:
    'Developed a full-stack MERN-based agricultural marketplace platform that connects farmers, buyers, delivery personnel, and administrators. Features include secure JWT authentication, product management, order processing, delivery tracking, inventory management, and real-time notifications for a seamless farming ecosystem.',
  technologies: [
    'React.js',
    'Node.js',
    'Express.js',
  ...
  image: '/pro5.PNG', // Change to your project image name
  live: 'https://terravale-main.onrender.com/', // Replace with your deployed URL
  github: 'https://github.com/fullstackdevarchon/uzhavan.FS',
  },
  {
    title: 'GRAND CHICKEN',
