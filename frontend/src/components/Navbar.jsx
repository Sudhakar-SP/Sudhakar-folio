    ...
    <header className="navbar-fixed pt-4">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 relative">
        ...
        <div className="hidden md:flex items-center space-x-4 relative z-10">
          {[
            { href: "https://www.linkedin.com/in/sudhakars2004/", icon: FaLinkedin, label: "LinkedIn" },
            { href: "https://github.com/Sudhakar-SP", icon: FaGithub, label: "GitHub" },
            { href: "https://mail.google.com/mail/?view=cm&fs=1&to=sudhakars2609@gmail.com&su=Portfolio%20Inquiry&body=Hello%20Sudhakar%2C", icon: FaEnvelope, label: "Email" },
          ].map((social) => (
            <motion.a
              key={social.label}
              href={social.href}
            ...
            <ul className="mt-16 space-y-6">
              ...
              <li className="pt-6 border-t border-white/10">
                <div className="flex justify-center space-x-6">
                  {[
                    { href: "https://www.linkedin.com/in/suthakar-s-34a938330/", icon: FaLinkedin, label: "LinkedIn" },
                    { href: "https://github.com/Sudhakar-SP", icon: FaGithub, label: "GitHub" },
                    { href: "https://mail.google.com/mail/?view=cm&fs=1&to=sudhakars2609@gmail.com&su=Portfolio%20Inquiry&body=Hello%20Sudhakar%2C", icon: FaEnvelope, label: "Email" },
                  ].map((social) => (
                    <motion.a
